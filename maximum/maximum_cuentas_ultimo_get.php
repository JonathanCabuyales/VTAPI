...
// $json = file_get_contents('php://input');
// $jsonCuenta = json_decode($json);
// $numero = $jsonCuenta->numero;
// $jwt = $jsonCuenta->token;
...
try {
    ...
    $get = mysqli_query($con, "SELECT * FROM cuentas_contables_libro WHERE numero LIKE '$numero%' ORDER BY numero DESC LIMIT 1");
